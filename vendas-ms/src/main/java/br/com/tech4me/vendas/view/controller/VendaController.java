...
import br.com.tech4me.vendas.view.model.VendaModeloAlteracao;
import br.com.tech4me.vendas.view.model.VendaModeloInclusao;
import br.com.tech4me.vendas.view.model.VendaModeloResponse;
...
public class VendaController {
    ...
    @GetMapping(value="/{filmeNm}/lista")
    public ResponseEntity<List<VendaModeloResponse>> obterPorDono(@PathVariable String filmeNm) {
        List<VendaDto> dtos = service.obterPorFilme(filmeNm);
